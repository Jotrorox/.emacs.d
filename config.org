...
#+BEGIN_SRC emacs-lisp
  (use-package emacs
    ...
    :config
    (setq frame-title-format '("Emacs")    ; Window Name
...
** GUI enhancements
*** Support icons
Install all the Icons for better icon support through a easy Installation
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
*** Load a custom modeline
Using Doom modeline, a really fancy and modern modeline solution
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
Alternative to Doom modeline, more minimal in design [Deprecated]
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  (use-package dashboard
    ...
    (setq dashboard-startup-banner 'logo
          dashboard-banner-logo-title "Yay Emacs!"
          dashboard-items nil
...
#+END_SRC
*** Documentation
A better alternative to the native emacs doc
#+BEGIN_SRC emacs-lisp
  (use-package helpful)
...
#+END_SRC
Tldr.el enables integration with the native tldr which is a better version of the man pages
#+BEGIN_SRC emacs-lisp
  (use-package tldr)
...
#+END_SRC
*** LSP
Setup LSPmode and LSP-ui for some better completions and lsp features
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
*** Snippets
yasnippet enables a good overall snippet utility
#+BEGIN_SRC emacs-lisp
...
**** Java
Setup the Java LSP server jdtls
#+BEGIN_SRC emacs-lisp
  (use-package lsp-java
    :after lsp)
#+END_SRC
Setup general java support
#+BEGIN_SRC emacs-lisp
  (use-package java
    :ensure nil
    :after lsp-java
...
#+END_SRC
**** VLang
A simple Vlang setup using a way to old plugin
#+BEGIN_SRC emacs-lisp
  (use-package v-mode
    :config
    :bind-keymap
...
#+END_SRC
**** ZigLang
Using the official zig-mode plugin but don't forget to download the language server!
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
Math preview in ORG using dvipng
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
*** Ement.el
The Ement.el client allows chatting with Matrix chatrooms right inside of emacs
#+BEGIN_SRC emacs-lisp
  (use-package ement)

  (global-set-key (kbd "C-x M-m c") 'ement-connect)
  (global-set-key (kbd "C-x M-m l") 'ement-list-rooms)
#+END_SRC
